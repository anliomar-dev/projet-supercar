<?php
    echo"
      <div class='sidebar start-0 ms-3 rounded-3 px-3' style='z-index: 1000;'>
        ...
        <a href='#' class='mb-3 d-flex primary-custom-btn mt-3 pt-2 home-btn rounded-3'>
        ...
        <div class='btn-group my-3'>
          ...
          <ul class='dropdown-menu px-2'>
            <li>
              <a class='dropdown-item text-dark d-flex align-items-center py-y' href='#'>
            ...
            <li>
              <a class='dropdown-item text-dark d-flex align-items-center py-2' href='#'>
