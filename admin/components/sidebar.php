<?php
    echo"
      <div class='sidebar start-0 ms-3 rounded-3 px-3' style='z-index: 1000;'>
        ...
        <div class='navbar-brand' href='/super-car/admin/dashboard'>
        ...
        <div class='btn-group my-3'>
          ...
          <ul class='dropdown-menu px-2'>
            ...
            <li>
              <a class='dropdown-item text-dark d-flex align-items-center py-2' href='/super-car/admin/images'>
              <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' class='size-5'>
        ...
        <a class='d-flex align-items-center py-2' href='/super-car/admin/calendrier'>
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' class='size-5'>
          ...
          <span class='ms-3 mt-1'>Calendrier</span>
        </a>
