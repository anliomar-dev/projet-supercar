<?php
  ...
  echo"
    <div class='sidebar .sidebarSmallScrren start-0 ms-3 rounded-3 px-3' style='z-index: 1000;'>
      ...
      <a href='/admin/dashboard.php' class='mb-3 d-flex primary-custom-btn mt-3 pt-2 home-btn rounded-3'>
      ...
      <div class='btn-group my-3'>
        ...
        <ul class='dropdown-menu px-2'>
          <li>
            <a class='dropdown-item text-dark d-flex align-items-center py-y' href='/admin/groupes.php'>
          ...
          <li>
            <a class='dropdown-item text-dark d-flex align-items-center py-2' href='/admin/permissions.php'>
          ...
          <li>
            <a class='dropdown-item text-dark d-flex align-items-center py-2' href='/admin/utilisateurs.php'>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' class='size-5'>
      ...
      <div class='btn-group my-3'>
        ...
        <ul class='dropdown-menu px-2'>
          <li>
            <a class='dropdown-item text-dark d-flex align-items-center py-2' href='/admin/marques.php'>
              <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' class='size-5'>
          ...
          <li>
            <a class='dropdown-item text-dark d-flex align-items-center py-2' href='/admin/modeles.php'>
          ...
          <li>
            <a class='dropdown-item text-dark d-flex align-items-center py-2' href='/admin/essais.php'>
      ...
      <a class='d-flex align-items-center py-2' href='/admin/contacts.php'>
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' class='size-5'>
      ...
      <a class='d-flex align-items-center py-2' href='/admin/evennements.php'>
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' class='size-5'>
      ...
      <a class='d-flex align-items-center py-2' href='/admin/horaires.php'>
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' class='size-5'>
      ...
      <a class='d-flex align-items-center py-2' href='/admin/newsletter.php'>
        <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke-width='1.5' stroke='currentColor' class='w-6 h-6'>
      ...
      <a class='d-flex align-items-center py-2' href='/admin/visites.php'>
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' class='size-5'>
