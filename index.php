                ...
                <div class="header_links-buttons">
                    ...
                    <nav class="header_menu">
                        <ul>
                            ...
                            <li><a href="" class="header_link">Marques</a></li>
            ...
            <div class="container action">
                <div class="text">
                    ...
                    <div class="buttons text-center col-12">
                        <button class="btn btn-primary animation4">contactez nous</button>
                        <a href="" class="btn btn-secondary animation5">inscrivez vous</a>
                    </div>
                </div>
                <div class="image">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="col-12 about_list">
                                        ...
                                        <h6>1- <a href="">inscrivez vous</a></h6>
                                        <h6>2- <a href="">connectez vous</a></h6>
                                        <h6>3- <a href="">demander l'essai en ligne</a></h6>
                                    </div>
                    ...
                    <div class="d-flex justify-content-center cards_content">
                        ...
                        <div class="looking-for_card">
                            <div class="looking-for_row row-essai">
                                ...
                                <div class="col-12 card_buttons">
                                    <a class="btn btn-primary" href="">Demander un essai</a>
